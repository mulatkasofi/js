...
productSection.addEventListener('click',(e)=>{
    ...
    if (productId) {
      ...
      basket.add(product);
     ul.innerHTML+=renderCard(product)
...
//           </div>
//           <div class="right-side">
//             <button class="cart-product__delete" aria-label="Удалить товар" data-todo-id=${product.id}>  &times;</button>
//             <span class="cart-product__price">${product.newPrise}</span>
//           </div>
